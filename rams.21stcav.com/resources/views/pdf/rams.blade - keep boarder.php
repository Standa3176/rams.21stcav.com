...
/* ── Cover ── */
.cover-title {
    font-size: 20pt;          /* 26pt wraps in Dompdf/DejaVu — capped at 20pt */
    font-weight: 700;
    color: #00788A;
    margin: 20pt 0 2pt;
}
...
@php
    ...
    $ppeDetails = [
        ...
        'Hi-Visibility Vest'           => ['All times on site',                 'EN ISO 20471'],
...
<div class="footer">
    <table class="footer-table">
        <tr>
            ...
            <td class="footer-right">{{ $rams->created_at->format('d M Y') }}</td>
        </tr>
    </table>
</div>
...
<table class="std-table">
    ...
    <tr><td class="lbl">Company Reg No.</td>      <td>{{ config('rams.company_reg', 'Available on request') }}</td></tr>
...
<ul class="blist">
    ...
    <li>A first aid kit will be available in the engineer's vehicle.</li>
