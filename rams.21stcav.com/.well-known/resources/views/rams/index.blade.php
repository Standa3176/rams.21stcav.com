                                ...
                                <div class="actions" style="flex-wrap:wrap;gap:.35rem;">
                                    ...
                                    @elseif (
                                        ...
                                        @if ($doc->filename)
                                            ...
                                            @if (! $sup)
                                                <form method="POST"
                                                      action="{{ route('rams.regenerate', $doc) }}"
                                                      onsubmit="return confirm('Regenerate? This will create a new version and mark this one as superseded.');"
                                                      style="margin:0;">
                                                    @csrf
                                                    <button type="submit" class="btn btn-outline btn-sm" title="Regenerate document">
                                                        &#x21BA; Regen
                                                    </button>
                                                </form>
                                    ...
                                    <form method="POST"
                                          ...
                                          onsubmit="return confirm('Delete this RAMS document? This cannot be undone.');"
                                          style="margin:0;">
                                        @csrf
                                        @method('DELETE')
