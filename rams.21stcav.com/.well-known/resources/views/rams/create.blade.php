...
@section('content')
    ...
    <form method="POST"
        ...
        ══════════════════════════════════════════════════════════════ --}}
        <div class="section-block">
            <h2 class="section-heading">B — Hazards <span class="req">*</span></h2>
        ...
        {{-- ════════════════════════════════════════════════════════════
             SECTION C — PPE Required
        ══════════════════════════════════════════════════════════════ --}}
        <div class="section-block">
            <h2 class="section-heading">C — PPE Required <span class="req">*</span></h2>
            <p style="font-size:.875rem; color:#555; margin-bottom:.9rem;">
        ...
        {{-- ════════════════════════════════════════════════════════════
             SECTION D — Persons at Risk
        ══════════════════════════════════════════════════════════════ --}}
        <div class="section-block">
            <h2 class="section-heading">D — Persons at Risk <span class="req">*</span></h2>
        ...
        {{-- ════════════════════════════════════════════════════════════
             SECTION E — Engineering Team
        ══════════════════════════════════════════════════════════════ --}}
        <div class="section-block">
            <h2 class="section-heading">E — Engineering Team <span style="font-weight:400; font-size:.9rem; color:#666;">(optional)</span></h2>
        ...
        ══════════════════════════════════════════════════════════════ --}}
        <div class="section-block">
            <h2 class="section-heading">F — Emergency Contact <span style="font-weight:400; font-size:.9rem; color:#666;">(optional)</span></h2>
        ...
        {{-- ════════════════════════════════════════════════════════════
             SECTION G — Document Author
        ══════════════════════════════════════════════════════════════ --}}
        <div class="section-block">
            <h2 class="section-heading">G — Document Author <span style="font-weight:400; font-size:.9rem; color:#666;">(optional)</span></h2>
        ...
        {{-- ════════════════════════════════════════════════════════════
             SECTION H — AI Provider (advanced, collapsible)
        ══════════════════════════════════════════════════════════════ --}}
        <div class="section-block">
