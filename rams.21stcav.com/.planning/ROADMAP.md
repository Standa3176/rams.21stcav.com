...
Plans:
- [x] 46-01-PLAN.md — Visit lifecycle: seven stored acts, the rest derived (wave 1)
...
Plans:
- [x] 46.2-01-PLAN.md — Four rows, and the every-visit-type invariant retired by name (wave 1, D-01)
