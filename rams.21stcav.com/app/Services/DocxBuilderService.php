...
class DocxBuilderService
{
    ...
    private function buildCoshhAssessment(PhpWord $phpWord, array $data): void
    {
        ...
        $coshhBoilerplate = [
            ...
            ['Dust generated by drilling / cutting', 'use FFP3 dust masks when drilling into plasterboard, masonry or MDF — all operatives face-fit tested. Use dust extraction where practicable.'],
